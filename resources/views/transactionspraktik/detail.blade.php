<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Transaction &raquo; Pratik By {{ $item->user->name }}
        </h2>
    </x-slot>
                ...
                <table class="table-auto w-full">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-6 py-4"><img src="{{ $item->praktik_photo_path }}" style="height: 100px; width: 100px; border-radius: 20px;"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="border px-6 py-4 text-left">Gejala Pertama</th>
                            <td class="border px-6 py-4">{{ $item->first_symptom }}</td>
                        </tr>
                        <tr>
                            <th class="border px-6 py-4 text-left">Gejala Kedua</th>
                            <td class="border px-6 py-4">{{ $item->second_symptom }}</td>
                        </tr>
                        <tr>
                            <th class="border px-6 py-4 text-left">Dokter Name</th>
                            <td class="border px-6 py-4">{{ $item->doctor->name }}</td>
                        </tr>
                        <tr>
