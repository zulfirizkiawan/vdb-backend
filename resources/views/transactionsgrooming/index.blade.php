        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           <div class="bg-white mt-8">
            <table class="table-auto w-full">
                ...
                <tbody>
                    @forelse($transactionsgrooming as $item)
                        <tr>
                            ...
                            <td class="border px-6 py-3" style=" display:flex; align-items:center; justify-content: space-evenly;">
                                    <a href="{{ route('transactionsgrooming.show', $item->id) }}" class="text-white font-bold py-2 px-4 rounded" style="background-color: #d2d43c;">
                                        View
                                    </a>
                                    <form action="{{ route('transactionsgrooming.destroy', $item->id) }}" method="POST" class="inline-block">
