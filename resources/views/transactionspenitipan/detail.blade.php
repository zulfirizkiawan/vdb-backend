<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Transaction &raquo; Penitipan By {{ $item->user->name }}
        </h2>
    </x-slot>
                ...
                <table class="table-auto w-full">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-6 py-4"><img src="{{ $item->penitipan_photo_path }}" style="height: 100px; width: 100px; border-radius: 20px;"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="border px-6 py-4 text-left">Tanggal Pemesanan</th>
                            <td class="border px-6 py-4">{{ date('Y-m-d H:m:s', $item->created_at) }}</td>
                        </tr>
                        <tr>
                            <th class="border px-6 py-4 text-left">Tanggal Pengembalian</th>
